...
document.addEventListener('click', function (event) {
    ...
    var bookName = div.getElementsByTagName("span")[0].innerText;
    var description = div.getElementsByTagName("h4")[0].innerText;
    var price = div.getElementsByTagName("h5")[0].innerText;
    var image = div.parentElement.getElementsByTagName("img")[0].src;
    var book = { bookName, description, price, image };
    console.log(book);
    cart.push(book);
});
